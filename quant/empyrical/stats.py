...
def annualization_factor(period, annualization):
    """
    Return annualization factors from period entered or if a custom
    value is passed in.
...
def cum_returns(returns, starting_value=0):
    ...
    ----------
    returns : pd.Series or np.ndarray
        Returns of the strategys as a percentage, noncumulative.
...
def aggregate_returns(returns, convert_to):
    ...
    ----------
    returns : pd.Series
       Daily returns of the strategys, noncumulative.
...
def max_drawdown(returns):
    """
    Determines the maximum drawdown of a strategys.
...
def annual_return(returns, period=DAILY, annualization=None):
    ...
    ----------
    returns : pd.Series or np.ndarray
        Periodic returns of the strategys, noncumulative.
        - See full explanation in :func:`~empyrical.stats.cum_returns`.
    period : str, optional
        Defines the periodicity of the 'returns' data for purposes of
        annualizing. Value ignored if `annualization` parameter is specified.
...
def annual_volatility(returns, period=DAILY, alpha=2.0,
                      annualization=None):
    """
    Determines the annual volatility of a strategys.
...
def calmar_ratio(returns, period=DAILY, annualization=None):
    """
    Determines the Calmar ratio, or drawdown ratio, of a strategys.
...
def omega_ratio(returns, risk_free=0.0, required_return=0.0,
    ...
    """Determines the Omega ratio of a strategys.
...
def sharpe_ratio(returns, risk_free=0, period=DAILY, annualization=None):
    """
    Determines the Sharpe ratio of a strategys.
...
def sortino_ratio(returns, required_return=0, period=DAILY,
    ...
    """
    Determines the Sortino ratio of a strategys.
...
def information_ratio(returns, factor_returns):
    """
    Determines the Information ratio of a strategys.
...
def alpha_beta(returns, factor_returns, risk_free=0.0, period=DAILY,
    ...
    factor_returns : pd.Series
         Daily noncumulative returns of the factors to which beta is
